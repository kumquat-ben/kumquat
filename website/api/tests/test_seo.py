...
class SeoSurfaceTests(TestCase):
    ...
    def test_home_page_emits_primary_seo_metadata(self):
        ...
        self.assertContains(response, "<title>Kumquat | Headless News Search For Agents</title>", html=False)
        ...
        self.assertContains(response, 'property="og:title" content="Kumquat | Headless News Search For Agents"', html=False)
