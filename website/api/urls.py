...
from .views import (
    ...
    messages_view,
    website_indexing_admin_page_view,
    privacy_policy_page_view,
    robots_txt_view,
    search_crawl_enqueue_view,
    search_typeahead_view,
    sign_in_page_view,
...
urlpatterns = [
    ...
    path("api/search/typeahead", search_typeahead_view, name="search-typeahead"),
    ...
    path("manage/website-indexing", website_indexing_admin_page_view, name="manage-website-indexing"),
    ...
    path("suggest-domain", domain_suggestion_submit_view, name="suggest-domain"),
