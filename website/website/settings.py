...
NODE_LAUNCHER_IMAGE = env(
    "NODE_LAUNCHER_IMAGE",
    "351381968847.dkr.ecr.us-west-2.amazonaws.com/kumquat-blockchain:blockchain-20260414-054817-824bbca",
)
...
NODE_LAUNCHER_GENESIS_HASH = env(
    ...
    "49be8808fea37733de5e619af4fa5745141c8edd63dc8ddf37deebf907d7c22f",
).strip().lower()
