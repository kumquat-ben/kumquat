...
impl ObjectTransactionRecord {
    ...
    pub fn create_signed(
        ...
        let mut tx = Self::new(sender, kind, gas_price, gas_limit, nonce);
...
mod tests {
    ...
    fn test_create_object_transaction() {
        ...
        let tx = ObjectTransactionRecord::new(sender, kind, 5, 21000, 1);
    ...
    fn test_delete_object_transaction() {
        ...
        let kind = ObjectTransactionKind::DeleteObject { id: object_id };
    ...
    fn test_sign_transaction() {
        ...
        let mut tx = ObjectTransactionRecord::new(sender, kind, 5, 21000, 1);
        ...
        let signed_tx = ObjectTransactionRecord::create_signed(
            &keypair,
            ObjectTransactionKind::DeleteObject { id: object_id },
            5,
            21000,
            2,
        );
