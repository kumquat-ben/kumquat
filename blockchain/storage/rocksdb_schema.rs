...
impl<'a> RocksDBManager<'a> {
    ...
    pub fn get_stats(&self) -> Result<DatabaseStats, KVStoreError> {
        ...
        stats.total_size_bytes = all_entries
            .iter()
...
mod tests {
    ...
    fn test_schema_keys() {
        ...
        assert_eq!(
            block_hash_key,
            "block_hash:0101010101010101010101010101010101010101010101010101010101010101"
        );
        ...
        assert_eq!(
            tx_block_key,
            "tx_block:123:0101010101010101010101010101010101010101010101010101010101010101"
        );
        ...
        assert_eq!(
            account_key,
            "state:0101010101010101010101010101010101010101010101010101010101010101"
        );
    ...
    fn test_key_parsing() {
        ...
        assert_eq!(
            Schema::parse_key(block_key.as_bytes()),
            KeyType::BlockByHeight
        );
        ...
        assert_eq!(
            Schema::parse_key(tx_key.as_bytes()),
            KeyType::TransactionByHash
        );
        ...
        assert_eq!(
            Schema::parse_key(account_key.as_bytes()),
            KeyType::AccountState
        );
    ...
    fn test_database_manager() {
        ...
        store
            .put(
                Schema::latest_block_height_key().as_bytes(),
                &10u64.to_be_bytes(),
            )
            .unwrap();
