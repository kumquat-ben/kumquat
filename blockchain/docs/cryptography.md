# Kumquat Cryptography Documentation

## Overview

This document provides a comprehensive overview of the cryptographic primitives and protocols used in the Kumquat blockchain. It explains the design choices, security considerations, and implementation details of the cryptographic components.

## Cryptographic Primitives

### Digital Signatures: Ed25519

Kumquat uses the Ed25519 signature scheme for digital signatures. Ed25519 is a modern, secure, and efficient signature scheme based on elliptic curve cryptography.
...
Kumquat uses the SHA-256 hash function for various cryptographic operations, including:
...
Kumquat uses a Merkle Patricia Trie (MPT) for efficient and secure state storage and verification.
...
**Implementation Details:**
- Custom implementation optimized for Kumquat's needs
...
Transactions in Kumquat are signed using the following protocol:
...
Addresses in Kumquat are derived from public keys using the following process:
...
Kumquat uses Merkle Patricia Tries for state verification:
